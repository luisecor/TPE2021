...
function content_616634765580c0_04103569 (Smarty_Internal_Template $_smarty_tpl) {
...
">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-<?php echo $_smarty_tpl->tpl_vars['categoria']->value->id_categoria;?>
" aria-expanded="false" aria-controls="flush-<?php echo $_smarty_tpl->tpl_vars['categoria']->value->id_categoria;?>
">
...
" class=" row accordion-collapse collapse" aria-labelledby="flush-heading<?php echo $_smarty_tpl->tpl_vars['categoria']->value->id_categoria;?>
...
?>
  ...
  </div><div class="col"><?php echo $_smarty_tpl->tpl_vars['categoria']->value->nombre;?>
  </div> 
                        <?php }?>
