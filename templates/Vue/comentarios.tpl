{literal}
    ...
    <div class="row">
        ...
        <div id="filtros" class="btn-group me-2" role="group" aria-label="First group">
                ...
                <button type="button" id="filtro-puntaje" class="btn btn-outline-secondary">1</button>
                <button type="button" id="filtro-puntaje" class="btn btn-outline-secondary">2</button>
                <button type="button" id="filtro-puntaje" class="btn btn-outline-secondary">3</button>
                <button type="button" id="filtro-puntaje" class="btn btn-outline-secondary">4</button>
                <button type="button" id="filtro-puntaje" class="btn btn-outline-secondary">5</button>
        </div>
    </div>
